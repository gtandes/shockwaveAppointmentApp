...
const vetdData = [
	{
		...
		vet_image: <Avatar alt='Perry Winkle' src='/static/images/avatar/3.jpg' />,
	},
	{
		...
		building: 'Green Bow Vett',
		contact_number: '+63 0123 123',
		vet_image: <Avatar alt='Anika Howard' src='/static/images/avatar/2.jpg' />,
	},
	{
	...
	},
	{
		...
		building: 'Green Bow Vett',
		contact_number: '+63 0123 123',
		vet_image: <Avatar alt='Sara Conners' src='/static/images/avatar/4.jpg' />,
	},
];
...
const VetCards: FC<VetCardsProps> = ({}) => {
	const { vetDetails, setvetDetails, setindividualApptDetails } =
